...
class ImageData(Dataset):
    def __init__(self, root_path='../data/data146107', data_path='dataset', flag='train', size=None, transform=None):
    ...
    def __read_data__(self):
        ...
        path = os.path.join(self.root_path, self.data_path)     # ../data/data146107/dataset
...
def getLoader(args, flag):
    if flag == 'train':
        ...
        shuffle = False
        drop_last = True
    dataset = ImageData(args.root_path, args.data_path, flag, args.size)
